        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="font-sans text-sm md:text-base text-zinc-400 leading-relaxed">
                ...
                . Fokus utama saya tertuju pada perancangan arsitektur aplikasi
                web berkinerja tinggi, penulisan kode yang bersih, serta
                optimalisasi alur konversi pengguna (*user flow*).
              </p>
              <p className="font-sans text-sm md:text-base text-zinc-400 leading-relaxed">
                Saya menjembatani logika backend yang kuat dan aman dengan
                desain antarmuka berselera brutalist modern. Mulai dari
                manajemen database relasional, sinkronisasi state, hingga
                animasi mikro frontend—setiap baris kode dikompilasi secara
                presisi untuk skala produksi.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full aspect-square border-4 border-black overflow-hidden bg-black flex items-center justify-center rounded-sm">
              ...
              <span className="absolute font-pixel text-[9px] text-white tracking-widest font-bold bg-black/80 px-2 py-1 border border-zinc-800 select-none">
                AZZ CORE
              </span>
            </div>

            <div className="mt-6">
              <h4 className="font-retro text-2xl font-black text-white uppercase tracking-tight">
                System Core
              </h4>
              <span className="font-mono text-xs text-zinc-500 uppercase tracking-widest block mt-1">
                Analog Vinyl Grid Vibe
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              ...
              <h3 className="font-retro text-3xl font-black text-white uppercase tracking-tight">
                Senjata Utama
              </h3>
              <p className="font-sans text-sm md:text-base text-zinc-400 leading-relaxed max-w-4xl">
                Kumpulan arsitektur teknologi fundamental yang saya gunakan
                secara intensif untuk men-deploy aplikasi web interaktif,
                mengelola penyimpanan database relasional, serta mengoptimalkan
                performa rendering sisi server (*SSR*):
              </p>
            </div>
